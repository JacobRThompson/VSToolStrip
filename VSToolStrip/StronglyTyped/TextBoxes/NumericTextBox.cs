...
{
    public abstract class NumericTextBox<TInput> : MessageTextBox, INumericControl<TInput>, IStronglyTypedTextBox<TInput> where TInput: struct, IFormattable, IEquatable<TInput>
    {
